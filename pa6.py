...
class DTree():
    def __init__(self, variable, threshold, lessequal, greater, outcome):
        if (variable is None and threshold is None and lessequal is None and greater is None) and (outcome is None):
...
observations = (60,0,8)  # Example tuple with observations (temperature, humidity)

print(tree.find_outcome(observations))  # Output: walk